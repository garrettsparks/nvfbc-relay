...
// Set in the environment the relaunched relay inherits, so it knows it was relaunched.
constexpr const char* kRelaunchMarker = "NVFBCR_RELAUNCHED";
...
// Starts this exe again with the given arguments, as a process that continues this one's log,
// and hands it the single-instance lock. Logs nothing further when the new process starts.
